...
public class UnfairAdvertisementApplication extends Application {
    ...
    public void start(Stage window) {
        ...
        NumberAxis yAxis = new NumberAxis(0.0, 77.5, 10);
        ...
        speeds.getData().add(new XYChart.Data("NDA - 77.4", 77.4));
        speeds.getData().add(new XYChart.Data("Fastie - 77.2", 77.2));
        speeds.getData().add(new XYChart.Data("SuperNet - 77.1", 77.1));
        speeds.getData().add(new XYChart.Data("Meganet - 77.1", 77.1));
